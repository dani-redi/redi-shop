...
> = {
  ...
  default: {
    ...
    image: 'size-[22cqw]',
    body: '',
    tag: 'px-[1.5cqw] py-[0.5cqw] text-[length:max(var(--mockup-text-min),2cqw)]',
    title: 'mt-[0.8cqw] text-[length:max(var(--mockup-text-min),3.1cqw)]',
    description: 'mt-[0.3cqw] text-[length:max(var(--mockup-text-min),2.5cqw)]',
    buy: 'mt-[0.8cqw] gap-[0.8cqw] text-[length:max(var(--mockup-text-min),2.5cqw)]',
    buyIcon: 'size-[2.8cqw]',
    chevron: 'size-[3.4cqw]',
  },
  ...
  compact: {
    ...
    image: 'size-[8cqw]',
    body: '',
    tag: 'px-[0.9cqw] py-[0.2cqw] text-[length:max(var(--mockup-text-min),1.25cqw)]',
    title: 'mt-[0.8cqw] text-[length:max(var(--mockup-text-min),1.9cqw)]',
    description: 'mt-[0.3cqw] text-[length:max(var(--mockup-text-min),1.6cqw)]',
    buy: 'mt-[0.8cqw] gap-[0.8cqw] text-[length:max(var(--mockup-text-min),1.6cqw)]',
    buyIcon: 'size-[1.8cqw]',
  },
  ...
  mini: {
    ...
    body: 'text-[length:max(var(--mockup-text-min),1cqw)] leading-none',
    tag: 'px-[0.7cqw] py-[0.15cqw] text-[length:max(var(--mockup-text-min),1cqw)] leading-none',
    title: 'mt-[0.3cqw] text-[length:max(var(--mockup-text-min),1.4cqw)]',
    description: 'mt-[0.2cqw] truncate text-[length:max(var(--mockup-text-min),1.15cqw)]',
    buy: 'mt-[0.25cqw] gap-[0.4cqw] text-[length:max(var(--mockup-text-min),1.25cqw)]',
