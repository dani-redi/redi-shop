...
export const heroProducts: HeroProductVisual[] = [
  {
    ...
    tone: 'hot',
    cardClassName:
      'absolute bottom-0 left-0 z-10 h-[13rem] w-[35%] animate-float md:bottom-4 md:h-[17.25rem] md:w-[31%] md:-rotate-4 lg:left-[3%] lg:h-[18.5rem] lg:w-[29%]',
  ...
  },
  {
    ...
    // desenhado em 1/0.6 do tamanho final (38% × 15.75rem) e reduzido a 60% (scale), para o
    // texto ficar na proporção do tablet; no desktop, protagonista 10–20% maior.
    image: cleanser,
    imageSmall: cleanserSmall,
    icon: Sparkles,
    tone: 'purple',
    cardClassName:
      'absolute bottom-0 left-1/2 z-30 h-[26.25rem] w-[63.33%] origin-bottom -translate-x-1/2 scale-60 md:top-0 md:bottom-auto md:h-[22rem] md:w-[37%] md:origin-top md:scale-110 lg:h-[24rem] lg:w-[34%] lg:scale-120',
    imageClassName: '',
  },
  {
    image: shoe,
    ...
    tone: 'purple',
    cardClassName:
      'absolute right-0 bottom-0 z-20 h-[13rem] w-[35%] animate-float [animation-delay:-3s] md:bottom-4 md:h-[17.25rem] md:w-[31%] md:rotate-4 lg:right-[3%] lg:h-[18.5rem] lg:w-[29%]',
